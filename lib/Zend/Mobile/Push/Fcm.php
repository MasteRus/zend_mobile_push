...
/** Zend_Mobile_Push_Message_Fcm **/
require_once 'Zend/Mobile/Push/Message/Fcm.php';

/** Zend_Mobile_Push_Response_Fcm **/
require_once 'Zend/Mobile/Push/Response/Fcm.php';
 ...
 * @version    $Id$
 */
class Zend_Mobile_Push_Fcm extends Zend_Mobile_Push_Abstract
{
     ...
     * Send Message
     *
     * @param Zend_Mobile_Push_Message_Fcm $message
     * @return Zend_Mobile_Push_Response_Fcm
     * @throws Zend_Mobile_Push_Exception
     */
    public function send(Zend_Mobile_Push_Message_Abstract $message)
    {
        ...
        return new Zend_Mobile_Push_Response_Fcm($response->getBody(), $message);
    }
}
