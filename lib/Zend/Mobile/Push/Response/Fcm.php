 ...
 * @version    $Id$
 */
class Zend_Mobile_Push_Response_Fcm
{
    ...
    /**
     * Message
     * @var Zend_Mobile_Push_Message_Fcm
     */
    protected $_message;
     ...
     */
    public function __construct($responseString = null, Zend_Mobile_Push_Message_Fcm $message = null)
    {
        if ($responseString) {
     ...
     * Get Message
     *
     * @return Zend_Mobile_Push_Message_Fcm
     */
     ...
     * @return Zend_Mobile_Push_Response_Fcm
     */
    public function setMessage(Zend_Mobile_Push_Message_Fcm $message)
    {
